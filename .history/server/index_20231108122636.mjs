...
app.get('/api', async (req, res) => {
  ...
  app.post("/api/cocktails", async (req, res) => {
    ...
    VALUES (
      'Mojito', 
      'Mint leaves muddled with sugar and lime juice, rum added and topped with soda water.', 
      'Cocktail', 
      1, 
      4.5, 
      'https://images.unsplash.com/photo-1632995561645-86a7777d3e7a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bW9qaXRvfGVufDB8fDB8fHww'
    )
    RETURNING *;
  `;
